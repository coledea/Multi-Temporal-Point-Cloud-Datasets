...
parser = argparse.ArgumentParser(prog='Findelengletscher - Dataset Statistics Computation')
parser.add_argument('input_path', help='The root folder of the point clouds created from the raw data')
...
def compute_statistics(input_folder, output_log_path, leave_progress_bar=False):
	...
	epochs = [[epoch.path] for epoch in os.scandir(input_folder)]
