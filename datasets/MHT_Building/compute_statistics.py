...
parser = argparse.ArgumentParser(prog='MHT Building - Dataset Statistics Computation')
parser.add_argument('input_path', help='The folder containing the extracted point clouds')
