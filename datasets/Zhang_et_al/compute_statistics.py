...
parser = argparse.ArgumentParser(prog='Zhang et al. - Dataset Statistics Computation')
...
def compute_statistics(input_folder, output_log_path, leave_progress_bar=False):
	...
	processing_order = [[[os.path.join(input_folder, 'ALS-g-raw.las'), 
						os.path.join(input_folder, 'ALS-u-raw.las')], 
					   [os.path.join(input_folder, 'RawPC(lasgrid)(39M).las')]]]
